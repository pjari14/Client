...
const contactus = () => {
  return (
    <>
      <section class="py-3 py-md-5 my-5 py-xl-8">
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-10 col-lg-8">
              <h3 class="fs-5 mb-2 text-secondary text-uppercase">Contact</h3>
              <h2
                class="display-5 mb-4 mb-md-5 mb-xl-8"
                style={{ color: "#062d4b" }}
              >
              ...
              <div class="row justify-content-xl-center">
                <div class="col-12 col-xl-11">
                  <div class="mb-4 mb-md-5">
                    ...
                    <div>
                      <h4 class="mb-2">Police station</h4>
                      <p class="mb-2">
                        Please visit your nearest police station for any
                        inquiry.
                      </p>
                      ...
                      <div class="mb-4 mb-sm-0">
                        ...
                        <div>
                          ...
                          <p class="mb-0">
                            <a
                              class="link-secondary text-decoration-none"
                              href="mailto:cyberiris@gmail.com"
                            >
                              cyberiris@gmail.com
                            </a>
                          </p>
                  ...
                  <div>
                    ...
                    <div>
                      <h4 class="mb-2">24/7 Availability</h4>
                    </div>
                  </div>
                </div>
              </div>
